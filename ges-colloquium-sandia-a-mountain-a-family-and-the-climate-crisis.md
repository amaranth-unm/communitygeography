...
<span id="photo-event"></span>[<img src="{{ '/wilson-flyer.png' | relative_url }}" loading="lazy" decoding="async" alt="Photo: GES Colloquium- Sandia: A Mountain, a Family, and the Climate Crisis" />]({{ '/wilson-flyer.png' | relative_url }})
