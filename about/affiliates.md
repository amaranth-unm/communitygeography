---
title: Faculty Affiliates at UNM
permalink: "/about/affiliates.html"
source_url: https://communitygeography.unm.edu/about/affiliates.html
section: About
section_url: "/about/index.html"
summary: "Faculty Affiliation Program\r\n\r\nThe Center for Community Geography seeks
  faculty affiliates willing to support its mission in one or more of the following
  ways:\r\n\r\nIdentify potential partnerships and/or projects in the Albuquerque
  area with a focus in human-environment relations.\r\nReview proposals for community-engaged
  research (for grad students) and/or community-engaged teaching (for faculty).\r\nPropose
  and/or participate in events that bring university and community knowledge producers
  together.\r\nDevelop strategies to value local environmental knowledge in academic
  research.\r\nParticipate in an annual meeting to discuss broad initiatives in community
  engagement at UNM.\r\n\r\nFaculty affiliation will convey the following rights and
  responsibilities:\r\nAffiliate profiles will be listed (and annually updated) on
  the Center for Community Geography website.\r\nAffiliates will be added to the Center's
  listserv for notification of events and initiatives.\r\nAffiliates will be eligible
  to submit grants through the Center, which provides F&A both to the PI and to the
  PI's department.\r\n\r\nAffiliates will be eligible for administrative support for
  projects and events that support the Center's mission.\r\nAffiliates will be invited
  annually to provide feedback on Center strategy and initiatives.\r\n\r\nEligibility\r\nAny
  UNM faculty member or postdoc is eligible to apply for affiliation, regardless of
  discipline or institutional location, if their interests align broadly with the
  Center's mission."
---

# Faculty Affiliates at UNM

**<img src="{{ '/about/joegarcia.jpg' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="262" height="328" alt="joegarcia.jpg" />Joe Garcia**
...
**<img src="{{ '/about/gwyneth-doland.jpg' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="290" height="290" alt="gwyneth-doland.jpg" />Gwyneth Doland**
...
<img src="{{ '/about/thomas-de-pree' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="250" height="293" alt="thomas-de-pree" />
...
 <img src="{{ '/about/kells-bio-pix.jpg' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="250" height="250" alt="kells-bio-pix.jpg" />
...
<img src="{{ '/about/soni-taylorshead-july-2022.jpg' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="250" height="333" alt="soni-taylorshead-july-2022.jpg" />** Dr. Silas Grant**
...
<img src="{{ '/about/headshot_zoom.jpg' | relative_url }}" loading="lazy" decoding="async" width="250" height="221" alt="headshot_zoom.jpg" />
...
<img src="{{ '/about/marygold.webp' | relative_url }}" loading="lazy" decoding="async" width="250" height="298" alt="marygold.webp" />
...
**<img src="{{ '/about/liping-yang.jpg' | relative_url }}" loading="lazy" decoding="async" width="250" height="250" alt="Photo of Dr. Yang" />**
...
<a href="https://lipingyang.org/" data-auth="NotApplicable" data-linkindex="0" data-safelink="true" rel="noopener noreferrer" target="_blank" title="https://lipingyang.org/">Dr. Yang</a> is a geospatial computer scientist. She directs the <a href="https://geoair.lipingyang.org/" data-auth="NotApplicable" data-linkindex="1" data-safelink="true" rel="noopener noreferrer" target="_blank" title="https://geoair.lipingyang.org/">GeoAIR Lab</a>*, *the focus of which are developing novel GeoAI methods and solving problems in various domains (e.g., climate change, emerging pathogen detection, and community engaged research and teaching) by leveraging GeoAI and Geovisualization.

**<img src="{{ '/about/milfordmuskett.jpg' | relative_url }}" class="img-left" loading="lazy" decoding="async" width="246" height="281" alt="MilfordMuskett" />Dr. Milford Muskett **(Diné) 
