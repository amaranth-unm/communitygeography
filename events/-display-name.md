...
# Lobo Garden Fall Party

<span id="photo-event"></span>[<img src="{{ '/events/lobo-garden-party-flyer.png' | relative_url }}" loading="lazy" decoding="async" alt="Photo: Lobo Garden Fall Party" />]({{ '/events/lobo-garden-party-flyer.png' | relative_url }})
