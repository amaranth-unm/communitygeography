---
title: UNM Spring Teaching Conference
permalink: "/events/unm-spring-teaching-conference.html"
source_url: https://communitygeography.unm.edu/events/unm-spring-teaching-conference.html
section: Events
...
<span id="photo-event"></span>[<img src="{{ '/events/ctlconference2024.png' | relative_url }}" loading="lazy" decoding="async" alt="Photo: UNM Spring Teaching Conference" />]({{ '/events/ctlconference2024.png' | relative_url }})
...
**[Click here for a full schedule of events and to register for the event.](https://ctl.unm.edu/instructors/spring-teaching-conference/spring-teaching-conference-2024-schedule.html)**
