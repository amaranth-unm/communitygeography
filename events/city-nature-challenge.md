...
<span id="photo-event"></span>[<img src="{{ '/events/cnc-ges-group.png' | relative_url }}" loading="lazy" decoding="async" alt="Photo: City Nature Challenge" />]({{ '/events/cnc-ges-group.png' | relative_url }})
